								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<a href="index.php?ok=product&act=chitiet">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Sản phẩm hot tuần này</h2>
							<p>giảm giá tới 50%</p>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Đăng ký ngay để nhận  <strong>PHẦN QUÀ</strong></p>
							<form>
