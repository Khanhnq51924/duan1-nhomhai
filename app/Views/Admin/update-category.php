                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="wg-box">
                                    ...
                                    <form action="?role=admin&act=update-post-category&id=<?= $_GET['id'] ?>" method="post">
                                        <div class="mb-5">
                                        ...
                                        <div class="mb-5">
                                            <h5><label for="name">Mô Tả</label></h5>
                                            <input type="text" id="description" placeholder="Nhập mô tả ..." name="description"
