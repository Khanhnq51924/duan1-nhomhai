                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            <li><a href="#"><i class="fa fa-map-marker"></i>Fpoly Trịnh Văn Bô</a></li>
                            <li><a href="#"><i class="fa fa-phone"></i>+840349690941</a></li>
                            <li><a href="#"><i class="fa fa-envelope-o"></i>bestbalo@hotmail.com</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <span class="copyright">
                        ...
                        Bản quyền &copy;<script>document.write(new Date().getFullYear());</script> Dự án 1 Nhóm 2 Trường cao đẳng Fpoly Hà Nội <i class="fa fa-heart-o" aria-hidden="true"></i>
                    </span>
                </div>
            </div>
            <!-- /row -->
